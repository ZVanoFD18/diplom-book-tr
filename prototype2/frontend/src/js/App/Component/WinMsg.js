'use strict';
console.log(' document.App.Component.WinMsg');

/**
 * Компонент общего назначения "Вывести пользователю текст"
 */
 document.App.Component.WinMsg = {
	...
	show(options) {
		...
		options = document.Helper.Obj.replaceMembers({
			title : document.App.localize(this.defaultTitle),
			message : document.App.localize(this.defaultMessage),
			textButtonClose : document.App.localize(this.defaultTextButtonClose),
